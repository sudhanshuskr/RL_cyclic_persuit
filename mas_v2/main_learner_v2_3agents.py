...
for i in range(50):
    ...
    for episode in tqdm(range(EPISODES), desc= "Episode number : {} of {} | Trajectory cost = {:.2f} ".format(i,EPOCH,traj_cost)):
        ...
        # a3 = Agent(-8,-8,0,name="3")
        # a4 = Agent(-10,-8,0,name="4")
        a1 = Agent(random.random()*2- 10,random.random()*2 - 10,name="1")
        a2 = Agent(random.random()*2 - 8,random.random()*2 - 10,name="2")
        a3 = Agent(random.random()*2 - 8,random.random()*2 - 8,name="3")
        # a4 = Agent(random.random()*2 - 10,random.random()*2 - 8,name="4")
        centroid_estimate =np.array([[-10,-10],[-8,-10],[-8,-8],[-10,-8]])
        a1.setTarget(a2)
        a2.setTarget(a3)
        a3.setTarget(a1)
        # a4.setTarget(a1)
